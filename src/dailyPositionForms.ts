...
export const DAILY_POSITION_FORMS: DailyPositionFormDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "balanceTemporaryJoints", label: "Balance Temporary Joints", type: "number", readonly: true, placeholder: "Calculated balance temporary joints" },
      { name: "tdc", label: "Target Date of Completion (TDC)", type: "date", required: true, placeholder: "Select Target Date of Completion" },
  ...
  },
  {
    ...
    fields: [
      { name: "majorSection", label: "Major Section", type: "select", required: true, placeholder: "Select Major Section" },
      { name: "section", label: "Section", type: "select", required: true, placeholder: "Select Section" },
      { name: "stationCode", label: "Faulty Station Name", type: "select", required: true, placeholder: "Select Faulty Station Name" },
  ...
  },
  {
    ...
    fields: [
      { name: "majorSection", label: "Major Section", type: "select", required: true, placeholder: "Select Major Section" },
      { name: "section", label: "Section", type: "select", required: true, placeholder: "Select Section" },
      { name: "stationCode", label: "Location of faulty TIB", type: "select", required: true, placeholder: "Select Location of faulty TIB" },

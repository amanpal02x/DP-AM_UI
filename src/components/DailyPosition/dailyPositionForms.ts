...
export const DAILY_POSITION_FORMS: DailyPositionFormDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "failureTime", label: "Fault Date & Time", type: "datetime-local", required: true, placeholder: "Select Date & Time" },
  ...
  },
  {
    ...
    badge: "PA",
    systemCode: "SECR/TEL/PA-16",
    description: "Passenger amenities display boards and guidance systems.",
    fields: [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "batteryCurrent", label: "Battery Current", type: "text", placeholder: "Enter battery current (e.g. 1.5A)" },
